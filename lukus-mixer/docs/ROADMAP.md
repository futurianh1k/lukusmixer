...
### 목표
10스템 → **12스템** (+ Strings, Brass, Woodwinds, Synth)
...
| ID | 태스크 | 우선순위 | 예상 |
|---|---|---|---|
| 3-1 | `query-bandit` 리포 클론 및 환경 구축 | P0 | 4h |
| 3-2 | Banquet 추론 파이프라인 래핑 | P0 | 8h |
| 3-3 | 레퍼런스 쿼리 오디오 수집 (바이올린, 트럼펫, 플룻, 신스) | P0 | 4h |
| 3-4 | Pass 5 구현: Other → Banquet → 롱테일 악기 | P0 | 8h |
| 3-5 | 사용자 커스텀 쿼리 업로드 기능 | P2 | 4h |
| 3-6 | UI: 쿼리 기반 분리 설정 패널 | P1 | 4h |
| 3-7 | 통합 테스트 및 품질 평가 | P0 | 4h |
